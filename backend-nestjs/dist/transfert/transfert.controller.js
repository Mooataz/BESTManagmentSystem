...
const update_transfert_dto_1 = require("./dto/update-transfert.dto");
let TransfertController = class TransfertController {
    transfertService;
    constructor(transfertService) {
        this.transfertService = transfertService;
    }
    async create(createTransfertDto, res) {
        try {
    ...
    async update(id, updateTransfertDto, res) {
        try {
...
__decorate([
    ...
    __metadata("design:paramtypes", [create_transfert_dto_1.CreateTransfertDto, Object]),
    __metadata("design:returntype", Promise)
], TransfertController.prototype, "create", null);
__decorate([
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], TransfertController.prototype, "findAll", null);
__decorate([
    (0, common_1.Get)(':id'),
    ...
    __metadata("design:paramtypes", [Number, Object]),
    __metadata("design:returntype", Promise)
], TransfertController.prototype, "findOne", null);
__decorate([
    (0, common_1.Patch)(':id'),
    __param(0, (0, common_1.Param)('id')),
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, update_transfert_dto_1.UpdateTransfertDto, Object]),
    __metadata("design:returntype", Promise)
], TransfertController.prototype, "update", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Number, Object]),
    __metadata("design:returntype", Promise)
], TransfertController.prototype, "remove", null);
exports.TransfertController = TransfertController = __decorate([
    (0, common_1.Controller)('transfert'),
    __metadata("design:paramtypes", [transfert_service_1.TransfertService])
], TransfertController);
