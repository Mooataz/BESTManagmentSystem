...
let SalesController = class SalesController {
    ...
    async create(createSaleDto, res) {
        try {
    ...
    async update(id, updateSaleDto, res) {
        try {
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], SalesController.prototype, "getByBranchId", null);
__decorate([
    (0, common_1.Get)('/findByUser/:userId'),
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], SalesController.prototype, "getByState", null);
__decorate([
    (0, common_1.Get)(),
