...
export declare class ApproveStockService {
    ...
    constructor(approveStockRepositry: Repository<ApproveStock>, stockPartRepositry: Repository<StockPart>, binRepositry: Repository<Bin>, referenceRepositry: Repository<Reference>, historyStockPartRepositry: Repository<HistoryStockPart>, tracabilityRepositry: Repository<Tracability>, companyRepositry: Repository<Company>);
    ...
    findAvailableParts(approveStockId: number, branchId: number): Promise<StockPart[]>;
    confirmPart(approveStockId: number, stockPartId: number, binDefectId: number, userId: number): Promise<ApproveStock>;
