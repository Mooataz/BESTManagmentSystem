...
export declare class ApproveStockController {
    ...
    getAvailableParts(id: number, branchId: number, res: any): Promise<any>;
    confirmPart(id: number, stockPartId: number, binDefectId: number, userId: number, res: any): Promise<any>;
