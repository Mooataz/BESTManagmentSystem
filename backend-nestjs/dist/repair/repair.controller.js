...
let RepairController = class RepairController {
    ...
    async updateWithPartsFiles(id, updateRepairDto, files) {
        const fileNames = (files ?? []).map(file => file.filename);
        const updatedRepair = await this.repairService.updateRepairWithParts(+id, updateRepairDto, fileNames);
        return {
            message: 'Mise à jour réussie',
            data: updatedRepair,
        };
    }
    async removeFile(id, fileId, res) {
        try {
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, update_repair_dto_1.UpdateRepairDto, Array]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __metadata("design:paramtypes", [Number, String, Object]),
    __metadata("design:returntype", Promise)
], RepairController.prototype, "removeFile", null);
__decorate([
    (0, common_1.Patch)(':id'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
...
__decorate([
    ...
    __param(0, (0, common_1.Param)('actuellyBranch', common_1.ParseIntPipe)),
    __param(1, (0, common_1.Res)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, Object]),
    __metadata("design:returntype", Promise)
