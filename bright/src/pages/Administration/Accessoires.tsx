...
import { addAccessoire, fetchAccessoire, updateAccessoire } from "../../api/Administration";
...
const handleSubmit = async () => {
    ...
    return (
        <React.Fragment>
            ...
            <Button variant="outlined" fullWidth  onClick={() => setOpen(true)}>Ajouter un nouvelle accessoire</Button>
            </Box>
