...
import { addPart, getListAllParts, updatePart } from '../../api/administration/ListAllParts';
...
export function ListAllParts(){
    const [message, setMessage] = React.useState<ListAllPart[]>([]);
    React.useEffect(() => {
        getListAllParts()
    ...
    return(
        <div>
            ...
            <Table aria-label="basic table">
                ...
                <thead>
                    <caption style={{ width: '200px' }}>Liste des piéces  </caption>
                    <tr>
...
export function AjoutPart(){
        const { notify } = useNotification();
    
        const [open, setOpen] = React.useState(false);
        const [isLoading, setIsLoading] = React.useState(false);
        const [error, setError] = React.useState<string | null>(null);
const [formData, setFormData] = React.useState<ListAllPart>({ description: '' });    const handleSubmit = async () => {
        setIsLoading(true);
        setError(null);
                ...
                >
                    ...
                    <Typography id="nested-modal-description" textColor="text.tertiary">
                        <Stack spacing={2}>
                            ...
                            <Input variant="soft" sx={underlineInputStyles} value={formData.description} onChange={(e)=>setFormData({ description: e.target.value })}/>
...
export function UpdatePart( {part}:Responsive){
    const { notify } = useNotification();
