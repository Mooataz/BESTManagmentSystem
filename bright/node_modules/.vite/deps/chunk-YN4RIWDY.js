...
var ChipDelete = React4.forwardRef(function ChipDelete2(inProps, ref) {
  ...
  return (0, import_jsx_runtime4.jsx)(SlotRoot, _extends({}, restOfRootProps, {
    children: children != null ? children : _Cancel || (_Cancel = (0, import_jsx_runtime4.jsx)(Cancel_default, {}))
  }));
});
...
var defaultRenderGroup = (params) => (0, import_jsx_runtime9.jsxs)(ListItem_default, {
  nested: true,
...
var Autocomplete = React8.forwardRef(function Autocomplete2(inProps, ref) {
    ...
    if (renderTags) {
      ...
      selectedOptions = value.map((option, index) => {
        ...
        return (0, import_jsx_runtime8.jsx)(Chip_default, {
          ...
          variant: "soft",
          color: "neutral",
          endDecorator: (0, import_jsx_runtime8.jsx)(ChipDelete_default, _extends({}, endDecoratorProps2), endDecoratorKey),
          sx: {
            minWidth: 0
          },
  ...
  const defaultRenderOption = (optionProps, option) => {
    ...
    return (0, import_jsx_runtime8.jsx)(SlotOption, _extends({}, rest, {
      children: getOptionLabel(option)
    }), key);
  };
  ...
  if (anchorEl) {
    ...
    popup = (0, import_jsx_runtime8.jsx)(VariantColorProvider, {
      ...
      children: (0, import_jsx_runtime8.jsx)(ListProvider_default, {
        nested: true,
        children: (0, import_jsx_runtime9.jsxs)(SlotListbox, _extends({}, listboxProps, {
  ...
  return (0, import_jsx_runtime9.jsxs)(React8.Fragment, {
    children: [(0, import_jsx_runtime9.jsxs)(SlotRoot, _extends({}, rootProps, {
      ...
      })), (0, import_jsx_runtime9.jsxs)(SlotWrapper, _extends({}, wrapperProps, {
...
//# sourceMappingURL=chunk-YN4RIWDY.js.map
