...
import { AddDemandeClient, getDemandeClient } from '../../../Redux/Actions/Administration/DemandeClient';
...
export default function AddDemandeclient() {
     const dispatch = useAppDispatch();
        ...
        const [description, setDescription] = useState<TypeUnique>({
            ...
            const handleSubmit = async () => {
                try {
                    await dispatch(AddDemandeClient(description )).then(() => {
                        dispatch(getDemandeClient())
                        setOpen(false);
                        notify('Demande ajouter avec success');
  ...
  return (
    <React.Fragment>
            ...
            >
                <DialogTitle>{"Ajouter un nouvelle demande"}</DialogTitle>
                <DialogContent>
                    <FormControl>
