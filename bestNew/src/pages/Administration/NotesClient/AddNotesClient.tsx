...
import { AddOneNoteCustomer, getNotesCustomer } from '../../../Redux/Actions/Administration/NotesCustomer';
...
export default function AddNotesClient() {
            ...
            const [description, setDescription] = useState<TypeUnique>({
                ...
                name:''
                        ...
                        const handleSubmit = async () => {
                            try {
                                await dispatch(AddOneNoteCustomer(description )).then(() => {
